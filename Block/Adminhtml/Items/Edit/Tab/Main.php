...
namespace Vihadigitalcom\ShopByBrand\Block\Adminhtml\Items\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
 ...
 /**
    ...
    /**
     * @var \Vihadigitalcom\Banner\Model\Status
     */
    protected $_status;
    /**
    ...
    public function __construct(
        ...
        \Vihadigitalcom\ShopByBrand\Model\Status $status,
        array $data = []
    ) {
    ...
    {
        $model = $this->_coreRegistry->registry('current_vihadigitalcom_shopbybrand_items');
