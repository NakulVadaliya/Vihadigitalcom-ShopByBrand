<?php
namespace Vihadigitalcom\ShopByBrand\Block;
class Index extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
         \Vihadigitalcom\ShopByBrand\Model\BrandFactory $brandFactory
    ) 
    {
    ...
    public function getBrands(){
		...
		$collection->addFieldToFilter('is_active' , \Vihadigitalcom\ShopByBrand\Model\Status::STATUS_ENABLED);
...
// 		return $model->getOptions();
		...
		$collection = $this->_brandFactory->create()->getCollection();
		$collection->addFieldToFilter('is_active' , \Vihadigitalcom\ShopByBrand\Model\Status::STATUS_ENABLED);
		$collection->addFieldToFilter('featured' , \Vihadigitalcom\ShopByBrand\Model\Status::STATUS_ENABLED);
