...
class Save extends \Vihadigitalcom\ShopByBrand\Controller\Adminhtml\Items
{
	...
	//             var_dump($data);die;
			...
			if(isset($data['logo']['value']) && strlen($data['logo']['value']) > 1)
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('vihadigitalcom_shopbybrand/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('vihadigitalcom_shopbybrand/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('vihadigitalcom_shopbybrand/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('vihadigitalcom_shopbybrand/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('vihadigitalcom_shopbybrand/*/');
