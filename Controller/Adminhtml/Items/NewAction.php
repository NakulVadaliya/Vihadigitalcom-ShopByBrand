...
use Vihadigitalcom\ShopByBrand\Model\Items;

class NewAction extends \Vihadigitalcom\ShopByBrand\Controller\Adminhtml\Items
{
	/**
...
//         var_dump(get_class_methods($model));
		foreach($model->getOptions() as $option){
			...
			$item = $this->_objectManager->create('Vihadigitalcom\ShopByBrand\Model\Items');
			if($option->getValue()){			
